 ...
 * to `redirect_uri` with `?code=...` in the query string. oauth-callback.ts reads the
...
export function MicrosoftLoginButton() {
  ...
  const loginWithMicrosoft = () => {
    sessionStorage.setItem(OAUTH_PROVIDER_STORAGE_KEY, 'microsoft')
    window.location.href = microsoftAuthUrl
  }

  return (
    <Button type="button" variant="outline" className="w-full" onClick={loginWithMicrosoft}>
